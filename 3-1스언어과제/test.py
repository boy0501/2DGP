...
class MainGUI():
    def __init__(self):
        ...
        Label(frame,text='투자금').pack()
        Label(frame,text='투자금').pack()
        self.text1 = Text(inputframe,width=22,height=1,wrap=WORD)
        self.text1.pack()
        self.text2 = Text(inputframe,width=22,height=1,wrap=WORD)
        self.text2.pack()
        self.text3 = Text(inputframe,width=22,height=1,wrap=WORD)
        self.text3.pack()
        window.mainloop()
MainGUI()